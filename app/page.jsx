...
export default function Home() {
  return (
    <main className="min-h-dvh">
      {/* --- START OF YOUR ORIGINAL HERO UI --- */}
      <section className="min-h-dvh bg-[url('/bg1.jpg')] bg-center bg-cover bg-no-repeat">
        <section className="min-h-dvh bg-black/70">
          <div className="text-white lg:w-2/3 mx-auto flex flex-col items-center justify-center gap-10 md:pt-20 pt-5 max-md:pt-10 max-md:p-3">
      ...
      {/* --- END OF YOUR ORIGINAL HERO UI --- */}

      {/* --- START OF NEW LIGHT-THEMED SECTIONS --- */}

      {/* Features Section */}
      <section className="py-24 bg-white">
        <div className="max-w-6xl mx-auto px-6">
          <div className="text-center mb-16">
            <h2 className="text-4xl font-black text-slate-900 mb-4">Why Med-Share?</h2>
            <div style={{ backgroundColor: Theme.primaryGreen }} className="h-1.5 w-20 mx-auto rounded-full"></div>
          </div>
            ...
            {[
              {
                ...
                desc: "Information is cross-checked by healthcare contributors to ensure accuracy and reliability.",
                icon: "🩺"
              },
              {
                title: "Community Driven",
                desc: "A collaborative space for Africans to share health experiences and localized solutions.",
                icon: "🤝"
              },
              {
                title: "Zero Barriers",
                desc: "Designed to be lightweight and accessible, ensuring health info reaches every corner of the continent.",
                icon: "📡"
              }
            ].map((item, index) => (
              <div key={index} className="p-8 rounded-3xl border border-slate-100 bg-slate-50/50 hover:shadow-lg transition-shadow">
