            ...
            {[
              {
                ...
                desc: "Access information vetted by healthcare professionals.",
              },
              {
                title: "Community Forum",
                desc: "Connect with others to share health experiences safely.",
              },
              {
                title: "Accessible Tools",
                desc: "Designed for low-bandwidth environments.",
              },
            ].map((feature, i) => (
              <div
                key={i}
                className="p-8 rounded-xl bg-slate-50 border border-slate-100 shadow-sm"
              >
                <h3
      ...
      <section className="py-20 bg-slate-50 text-slate-900">
        <div className="max-w-4xl mx-auto px-6 text-center">
          ...
          <blockquote className="text-2xl italic text-slate-700 mb-6">
            "Med-Share Africa has made it so much easier for me to find reliable
            health advice in my local community. It is a true lifeline."
          </blockquote>
      ...
      <section className="py-20 bg-white text-center px-6">
        <div className="max-w-2xl mx-auto">
          ...
          <p className="text-slate-600 mb-8">
            Join our newsletter to receive the latest medical tips and community
