...
export default function Home() {
  return (
   ...
   <div className="text-white lg:w-2/3 mx-auto flex flex-col items-center justify-center gap-10 lg:pt-20 pt-5">
    <h1 className="text-5xl font-black">Welcome to <span style= {{color:Themes.primaryGreen}} className="italic">Med-Share Africa</span> </h1>
    ...
    <div className="flex items-center gap-5">
      <Link href={"/"} style={{backgroundColor: Themes.secondaryGreen}} className="text-xl px-10 py-3 rounded-full">Share Info </Link>
      <Link href={"/"} style={{backgroundColor: Themes.secondaryGreen}} className="text-xl px-10 py-3 rounded-full">Explore Resources </Link>
