  ...
  return (
    <main className="min-h-dvh bg-[url('/bg1.jpg')] bg-center bg-cover bg-no-repeat">
      <section className="min-h-dvh bg-black/70">
        <div className="text-white lg:w-2/3 mx-auto flex flex-col items-center jusifty center gap-10 lg:pt-20 pt-5">
          ...
          <p className="text-2xl font-light text-center">
            ...
            It creates a space where knowledge flows freely, empowering users to
          ...
          <div className="flex items-center gap-5">
            <Link
              ...
              className="text-xl px-10 py-3 rounded-full"
            >
              Share Info
            </Link>
            <Link
