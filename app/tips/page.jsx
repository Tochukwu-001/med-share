  ...
  const initialTips = [
    {
      ...
      category: "Wellness",
      content:
        "Proper hydration is essential for regulating body temperature and ensuring organ function, especially in high-heat environments. Dehydration can lead to fatigue, dizziness, and more serious heat-related illnesses.",
      preventiveAdvice:
        "Drink at least 3 liters of water daily and avoid excessive caffeine which can act as a diuretic.",
    ...
    },
    {
      ...
      content:
        "Malaria remains a significant health challenge. Recognizing early symptoms like intermittent fever, chills, and headaches can lead to faster treatment and better outcomes.",
      preventiveAdvice:
        "Always sleep under insecticide-treated nets and clear stagnant water around your living area.",
      author: "John Mensah",
    ...
    },
    {
      ...
      category: "Nutrition",
      content:
        "Consuming seasonal fruits like Mangoes and Pawpaws provides essential Vitamin C and antioxidants that boost the immune system and improve skin health.",
      preventiveAdvice:
        "Incorporate at least two servings of colorful fruits into your morning routine.",
      ...
      <section className="bg-white border-b border-slate-200 py-16 px-6 mb-12">
        <div className="max-w-6xl mx-auto text-center">
          ...
          <p className="text-slate-500 text-lg max-w-2xl mx-auto">
            Browse verified medical tips and health advice submitted by our
            community.
          </p>
        </div>
      </section>
          ...
          {tips.map((tip) => (
            ...
            >
              <div className="p-8 flex flex-col h-full relative">
                ...
                <div
                  className="bg-slate-50 p-4 rounded-2xl mb-6 border-l-4"
                  style={{ borderLeftColor: Theme.secondaryGreen }}
                >
                  <h4 className="text-[10px] font-black mb-1 uppercase text-slate-400 tracking-tighter">
                    Quick Tip:
                  </h4>
